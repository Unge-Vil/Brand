...
**Version:** 2.0 BETA **Role:** Master Source of Truth for Design & Development **Usage:** Provide this file to AI agents to ensure strict adherence to the brand guidelines.
...
**Font Family:** `Inter` (Google Fonts). **Fallback:** `Arial`, sans-serif.
...
-   **Modules (Content):**
    ...
    1.  _Blanke Ark_ (Need analysis)
        
    2.  _Gi det videre_ (Peer-learning)
        
    3.  _IdéLab_ (Workshop)
        
    4.  _Forståelse_ (Context)
...
-   **Alias:** "Kollektivet [Stedsnavn]" (e.g. _Kollektivet Haugalandet_).
